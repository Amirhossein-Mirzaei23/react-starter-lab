import { Button, Field, Fieldset, Tabs } from '@chakra-ui/react';
import { useNavigate } from 'react-router-dom';
import { useHeaderStore } from '@/app/store';
import React, { useMemo, useState } from 'react';
import { useNavigationStore } from '../../../store/slices/navigationStore/navigationStore';
import { type Options, passwordStrength } from 'check-password-strength';
import { PasswordInput, PasswordStrengthMeter } from '../../../components/ui/password-input';
import { userRegisterApi } from '../api/register-api';
import {
  UserLoginPayload,
  UserRegisterPayload,
...
export function Authentication() {
  ...
  function checPassWordValidation() {
    let hasError = false;
    setPasswordError('');
    if (strength < 2) {
  ...
  function submitForm() {
    ...
    if (isSignup) {
      hasError =
        ...
        checPassWordValidation();
    } else {
      hasError = checPhoneValidation() || checPassWordValidation();
    }
